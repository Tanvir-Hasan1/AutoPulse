...
const SettingsTab = ({ notificationSettings, toggleNotification, styles }) => (
  <ScrollView style={styles.tabContent} showsVerticalScrollIndicator={false}>
    ...
    <View style={styles.settingsContainer}>
      <View style={styles.settingItem}>
        ...
        <Switch
          ...
          thumbColor={notificationSettings.maintenance ? "#10B981" : "#9CA3AF"}
        />
      </View>
      <View style={styles.settingItem}>
        <View style={styles.settingInfo}>
      ...
      <View style={styles.settingItem}>
        ...
        <Switch
          ...
          trackColor={{ false: "#E5E7EB", true: "#A7F3D0" }}
          thumbColor={notificationSettings.marketplace ? "#10B981" : "#9CA3AF"}
        />
      </View>
      <View style={styles.settingItem}>
        <View style={styles.settingInfo}>
        ...
        <Switch
          ...
          trackColor={{ false: "#E5E7EB", true: "#A7F3D0" }}
          thumbColor={notificationSettings.performance ? "#10B981" : "#9CA3AF"}
        />
      </View>
      <View style={styles.settingItem}>
        <View style={styles.settingInfo}>
    ...
    <View style={styles.settingsFooter}>
      ...
      <TouchableOpacity style={[styles.settingsButton, styles.signOutButton]}>
